...
import com.javateam.portfolio.dao.BoardDAO;
...
public class BoardService {
	...
	@Transactional(readOnly = true)
	public List<BoardVO> selectBoardBySorting(){
		
		return ((List<BoardVO>)boardDAO.findAll(Sort.by(Direction.DESC, "boardReadCount"))).subList(0, 3);
