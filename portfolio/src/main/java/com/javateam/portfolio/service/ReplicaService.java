...
import com.javateam.portfolio.dao.ReplicaImpl;
...
public class ReplicaService {
	...
	public List<ReplicaVO> selectReplicaByPaging(int currPage, int limit) {
	...
	@Transactional(readOnly = true)
	public ReplicaVO selectReplica(int prdNum) {
		
		return impl.findByPrdNum(prdNum);
	}
	
	@Transactional(readOnly = true)
	public List<ReplicaVO> selectReplicasBySearching(int currPage, int limit, String searchKey, String searchWord) {
	...
	@Transactional(readOnly = true)
	public int selectReplicasCountBySearching(String searchKey, String searchWord) {
	...
	@Transactional(readOnly = true)
	public int selectReplicaCountByPrdNum() {
