...
@Slf4j
public class ReplicaListController {
	...
	public String list(@RequestParam(value="currPage", defaultValue="1") int currPage,
		...
		int listCount = replicaService.selectReplicaCountByPrdNum();
		
		replicaList = replicaService.selectReplicaByPaging(currPage, limit);
