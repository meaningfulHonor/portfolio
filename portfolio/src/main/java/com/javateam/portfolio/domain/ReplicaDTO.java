...
public class ReplicaDTO {
	// 번호
		...
		// VO -> DTO
		public ReplicaDTO(ReplicaVO replicaVO) {
			
			this.cno = replicaVO.getCno();
			this.prdCode = replicaVO.getPrdCode();
			this.prdNum = replicaVO.getPrdNum();
			this.prdName = replicaVO.getPrdName();
			this.prdPrice = replicaVO.getPrdPrice();
			// this.prdImg = replicaVO.getPrdImg();
			this.imgPath = replicaVO.getImgPath();
			this.company = replicaVO.getCompany();
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			ReplicaDTO other = (ReplicaDTO) obj;
			if (cno != other.cno)
				return false;
			if (company == null) {
